...
public class CreateDerbyDB
{
	...
	private void createTable(Connection conn) throws SQLException
	{
		...
		executeCommand(conn, "CREATE TABLE PURCHASELIST(ID INT GENERATED BY DEFAULT AS IDENTITY,"
				...
				+ "Distrabution VARCHAR(4),"
				+ "Car VARCHAR(20),"
				+ "TansCost INT,"
				+ "PRIMARY KEY (ID))");
		println("Creating table SALE...");
		executeCommand(conn, "CREATE TABLE SALELIST(ID INT GENERATED BY DEFAULT AS IDENTITY,"
				+ "CreateTime TIMESTAMP,"
				+ "OrderTime DATE,"
				+ "Customer VARCHAR(30),"
				+ "Classification VARCHAR(30),"
				...
				+ "TansCost INT,"
				+ "PRIMARY KEY (ID))");
		println("Creating table  WAREHOUSE...");
		executeCommand(conn, "CREATE TABLE WAREHOUSELIST(ID INT GENERATED BY DEFAULT AS IDENTITY,"
				+ "CreateTime TIMESTAMP,"
				+ "OrderTime DATE,"
				+ "Style VARCHAR(30),"
				+ "Classification VARCHAR(30),"
